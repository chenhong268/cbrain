...
├──────────────────────────────────────────┤
│  MCP Server (96 tools, stdio + HTTP)     │  ← Agent interface: CRUD, search, graph, jobs
├──────────────────────────────────────────┤
│  Core Engine                             │
│  ┌──────────┬──────────┬──────────────┐  │
│  │ Ingest   │ Search   │ Graph        │  │
...
| Alias | alias, add_alias, remove_alias | Alias management; old names remain compatibility aliases |
