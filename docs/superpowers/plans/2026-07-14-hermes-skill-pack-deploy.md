...
**Issue:** #334
**Base:** `2376a64bc84009007e0d441a08732a62fb192bd0`
**预期 commit message:** `fix(skill-pack): prefer trusted copy deployment for Hermes (#334)`（最终 commit SHA 仅在交付报告中提供，不写入本 commit 自身——避免 SHA 自引用）
