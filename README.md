...
```bash
bun install -g github:chenhong268/cbrain#v2.0.17
```
...
See [CHANGELOG.md](./CHANGELOG.md) for the full version history (current: v2.0.17).

| Version | Focus | Status |
|:--------|:------|:-------|
| v2.0.17 | 直接生日查询的证据归属修复 | ✅ Current |
