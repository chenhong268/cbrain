...
```bash
bun install -g github:chenhong268/cbrain#v2.0.18
```
...
See [CHANGELOG.md](./CHANGELOG.md) for the full version history (current: v2.0.18).

| Version | Focus | Status |
|:--------|:------|:-------|
| v2.0.18 | 已检出生日证据的正向准入修复 | ✅ Current |
